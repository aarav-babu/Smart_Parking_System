  ...
  const char *ssid =  "Arfaan m31";     // Enter your WiFi Name
  const char *pass =  "juei7076"; // Enter your WiFi Password

  #define MQTT_SERV "io.adafruit.com"
  #define MQTT_PORT 1883
  #define MQTT_NAME "aarav24"
  #define MQTT_PASS "aio_oTrK06jWX7gp5OsNsW4XI5Kep0E8"
  WiFiUDP ntpUDP;
  ...
  void setup() {
    ...
    timeClient.begin(); 
    myservo.attach(D5);      // Exit servo pin to D6
    myservos.attach(D4);       // Entry servo pin to D5
